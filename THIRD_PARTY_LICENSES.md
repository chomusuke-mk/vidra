...
Vidra distributes a Flutter client from this repository and a Python runtime package described by `app/requirements/*.txt`. The backend application itself resides in `vidra-backend`; only the runtime dependencies packaged from this repository are listed here, including dynamic binaries downloaded when the application requires them.
...
| cached_network_image                | ^4.0.0           | MIT          | Keep MIT license notice.                                               | third_party_licenses/cached_network_image                          |
| flutter_cache_manager               | ^3.4.2           | MIT          | Keep MIT license notice.                                               | third_party_licenses/flutter_cache_manager                         |
| serious_python                      | ^4.7.0           | Apache-2.0   | Keep LICENSE and NOTICE for appliance distributions.                   | third_party_licenses/serious_python                                |
| permission_handler                  | ^13.0.2          | MIT          | Keep MIT license notice.                                               | third_party_licenses/permission_handler                            |
| filesystem_picker                   | ^4.1.0           | BSD-3-Clause | Keep BSD notice and disclaimer.                                        | third_party_licenses/filesystem_picker                             |
| external_path                       | ^3.0.0           | MIT          | Keep MIT license notice.                                               | third_party_licenses/external_path                                 |
| flutter_local_notifications         | ^22.3.1          | BSD-3-Clause | Keep BSD notice and disclaimer.                                        | third_party_licenses/flutter_local_notifications                   |
...
| mime                                | ^2.1.0           | BSD-3-Clause | Keep BSD notice and disclaimer.                                        | third_party_licenses/mime                                          |
...
| dio                                 | ^5.11.1          | MIT          | Keep MIT license notice.                                               | third_party_licenses/dio                                           |
| archive                             | ^4.3.0           | MIT          | Keep MIT license notice.                                               | third_party_licenses/archive                                       |
...
| file_picker                         | ^12.3.0          | MIT          | Keep MIT license notice.                                               | third_party_licenses/file_picker                                   |
...
| tutorial_coach_mark                 | ^1.3.4           | MIT          | Keep MIT license notice.                                               | third_party_licenses/tutorial_coach_mark                           |
| flutter_inappwebview                | ^6.1.5           | Apache-2.0   | Keep Apache license text in distributions.                             | third_party_licenses/flutter_inappwebview                          |
| font_awesome_flutter                | ^11.0.0          | MIT          | Keep MIT license notice.                                               | third_party_licenses/font_awesome_flutter                          |
...
- **License Texts**: Each entry mentioned above has its original license stored verbatim under the `third_party_licenses/` directory (or linked in case the distribution includes it). Include that directory or a generated `THIRD_PARTY_LICENSES.txt` file in each installer.
- **Notices in binaries**: When packaging with `serious_python` or compiling Flutter releases, copy `THIRD_PARTY_LICENSES.md` so end-users can review third-party terms.
- **Copyleft Dependencies**: `mutagen` is licensed under GPL-2.0-or-later. If you distribute Vidra externally, you must provide the corresponding backend package source code to satisfy GPL obligations.
- **Changes and contributions**: Document directly any local modification to Apache-2.0 or MPL-2.0 components within this file and regenerate the affected license text if necessary.
